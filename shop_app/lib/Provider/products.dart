...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndShow() async {
    final url = Uri.parse(
        "https://shop-app-84dbd-default-rtdb.firebaseio.com/products.json");
    try {
  ...
  Future<void> replaceProduct(String id, Product newProduct) async {
    ...
    if (_itemIndex >= 0) {
      final url = Uri.parse(
          "https://shop-app-84dbd-default-rtdb.firebaseio.com/products/$id.json");
      try {
  ...
  Future<void> deleteProduct(String id) async {
    ...
    final _existingProductId = _items.indexWhere((element) => element.id == id);
